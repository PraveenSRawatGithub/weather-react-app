export default function NextForecast(props) {
    ...
    return (
        <>
            <div className=' text-white text-lg font-semibold ml-5 mt-[0.3rem] text-center'>6 days Weather forecast</div>
            <div className='grid grid-cols-2 m-2 md:grid-cols-3 2xl:grid-cols-6 mt-[0.1rem]'>
                ...
                {props.data.map(data => {
                    return (
                        <div key={data.date} className=' flex flex-col justify-between items-center bg-slate-800 text-white rounded-2xl shadow-md shadow-slate-900 m-1 px-4 py-2 text-center '>
